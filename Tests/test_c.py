...
# Test title
title = "DETERMINATION TEST - FORM C - ACTIVE"


# ------------------------------------------   Functions
# Define a Function to call test program in the menu app
class TestProgramFormC:
    def __init__(self):
        # Predefine buttons
    ...
    def test_program_run(self, user, input_device, device_ip):
        ...
        pygame.display.set_caption("DT Test Form C")
        ...
        current_score_id = user_database.insert_into_score_table("C",
